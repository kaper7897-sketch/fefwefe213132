...
function initEventListeners() {
    ...
    document.querySelectorAll('#catalog-filters .category-card').forEach(filter => {
        filter.addEventListener('click', function() {
            document.querySelectorAll('#catalog-filters .category-card').forEach(f => f.classList.remove('active'));
...
function initPageFromHash() {
    ...
    const validPages = ['home', 'catalog', 'favorites', 'cart', 'login', 'register'];
